...
// 3.Views Icon
export const ViewsIcon: React.FC<IconProps> = ({ className }) => (
...
// 4.Comments Icon
export const CommentsIcon: React.FC<IconProps> = ({ className }) => (
...
// 5.Upvote Icon (Heart)
interface UpvoteIconProps extends IconProps {
  isActive?: boolean;
}
export const UpvoteIcon: React.FC<UpvoteIconProps> = ({ className, isActive }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill={isActive ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const DownvoteIcon: React.FC<DownIconProps> = ({ className }) => (
...
// 7.Save Icon (Bookmark)
interface SaveIconProps extends IconProps {
  isSaved?: boolean;
}
export const SaveIcon: React.FC<SaveIconProps> = ({ className, isSaved }) => (
...
// 21.Rupee Icon
export const RupeeIcon: React.FC<IconProps> = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
// 24.EmojiPicker Icon
export const EmojiPickerIcon: React.FC<IconProps> = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-gray-300">
